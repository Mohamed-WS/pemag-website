...
async function cleanupDuplicates() {
    console.log("Cleaning up all duplicate data...");
    ...
    await db.insert(services).values(uniqueServicesData);
    console.log("Unique services inserted successfully");

    // Insert unique blog posts
    ...
    await db.insert(blogPosts).values(uniqueBlogData);
    console.log("Unique blog posts inserted successfully");

    // Insert unique testimonials
    const uniqueTestimonialsData = [
        {
            name: "Ahmed Rahman",
    ...
    await db.insert(testimonials).values(uniqueTestimonialsData);
    console.log("Unique testimonials inserted successfully");
    ...
    await db.insert(projects).values(uniqueProjectsData);
    console.log("Unique projects inserted successfully");
